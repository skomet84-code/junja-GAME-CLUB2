...
// 777 jackpot chance is exactly 15% per spin while this event is active.
...
const autoRestorePatch = `${sevenJackpotAnchor}\n      if(sevenJackpot&&sevenEventActive){\n        gameStateSet(TEMP_SLOT_777_EVENT_KEY,{active:false,startedAt:gameStateGet(TEMP_SLOT_777_EVENT_KEY,{})?.startedAt||null,endedAt:Date.now(),targetPct:15,winnerUserId:u.id,winnerNickname:u.nickname||null});\n      }`;
