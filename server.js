...
const SHOP_ITEMS = [
  ...
  {id:'char_m_blade',category:'character',gender:'M',asset:'/art/v29/characters/char_m_blade.svg',name:'블레이드 렌',icon:'⚔',rarity:'mythic',price:120000000,desc:'JUNJA LAND 신규 프리미엄 컬렉션 캐릭터'},
  {id:'char_m_sirius',category:'character',gender:'M',asset:'/art/v29/characters/char_m_sirius.svg',name:'시리우스',icon:'✦',rarity:'mythic',price:180000000,desc:'JUNJA LAND 신규 프리미엄 컬렉션 캐릭터'},
  {id:'char_m_kaiser',category:'character',gender:'M',asset:'/art/v29/characters/char_m_kaiser.svg',name:'카이저',icon:'♜',rarity:'mythic',price:260000000,desc:'JUNJA LAND 신규 프리미엄 컬렉션 캐릭터'},
  {id:'char_m_raven',category:'character',gender:'M',asset:'/art/v29/characters/char_m_raven.svg',name:'레이븐',icon:'♠',rarity:'mythic',price:340000000,desc:'JUNJA LAND 신규 프리미엄 컬렉션 캐릭터'},
  {id:'char_m_orion',category:'character',gender:'M',asset:'/art/v29/characters/char_m_orion.svg',name:'오리온',icon:'★',rarity:'mythic',price:420000000,desc:'JUNJA LAND 신규 프리미엄 컬렉션 캐릭터'},
  {id:'char_m_zephyr',category:'character',gender:'M',asset:'/art/v29/characters/char_m_zephyr.svg',name:'제피르',icon:'♨',rarity:'mythic',price:520000000,desc:'JUNJA LAND 신규 프리미엄 컬렉션 캐릭터'},
  {id:'char_m_sol',category:'character',gender:'M',asset:'/art/v29/characters/char_m_sol.svg',name:'솔 레갈리아',icon:'☀',rarity:'mythic',price:620000000,desc:'JUNJA LAND 신규 프리미엄 컬렉션 캐릭터'},
  {id:'char_m_abyss',category:'character',gender:'M',asset:'/art/v29/characters/char_m_abyss.svg',name:'어비스',icon:'◆',rarity:'mythic',price:720000000,desc:'JUNJA LAND 신규 프리미엄 컬렉션 캐릭터'},
  {id:'char_m_valor',category:'character',gender:'M',asset:'/art/v29/characters/char_m_valor.svg',name:'발러',icon:'♛',rarity:'mythic',price:850000000,desc:'JUNJA LAND 신규 프리미엄 컬렉션 캐릭터'},
  {id:'char_m_celest',category:'character',gender:'M',asset:'/art/v29/characters/char_m_celest.svg',name:'셀레스트 킹',icon:'✧',rarity:'mythic',price:950000000,desc:'JUNJA LAND 신규 프리미엄 컬렉션 캐릭터'},
  {id:'char_f_sakura',category:'character',gender:'F',asset:'/art/v29/characters/char_f_sakura.svg',name:'사쿠라 벨',icon:'❀',rarity:'mythic',price:120000000,desc:'JUNJA LAND 신규 프리미엄 컬렉션 캐릭터'},
  {id:'char_f_elise',category:'character',gender:'F',asset:'/art/v29/characters/char_f_elise.svg',name:'엘리제',icon:'♫',rarity:'mythic',price:180000000,desc:'JUNJA LAND 신규 프리미엄 컬렉션 캐릭터'},
  {id:'char_f_rose',category:'character',gender:'F',asset:'/art/v29/characters/char_f_rose.svg',name:'블랙 로즈',icon:'♥',rarity:'mythic',price:260000000,desc:'JUNJA LAND 신규 프리미엄 컬렉션 캐릭터'},
  {id:'char_f_angel',category:'character',gender:'F',asset:'/art/v29/characters/char_f_angel.svg',name:'셀레스티아',icon:'✧',rarity:'mythic',price:340000000,desc:'JUNJA LAND 신규 프리미엄 컬렉션 캐릭터'},
  {id:'char_f_lilith',category:'character',gender:'F',asset:'/art/v29/characters/char_f_lilith.svg',name:'릴리스',icon:'♠',rarity:'mythic',price:420000000,desc:'JUNJA LAND 신규 프리미엄 컬렉션 캐릭터'},
  {id:'char_f_regina',category:'character',gender:'F',asset:'/art/v29/characters/char_f_regina.svg',name:'레지나',icon:'♕',rarity:'mythic',price:520000000,desc:'JUNJA LAND 신규 프리미엄 컬렉션 캐릭터'},
  {id:'char_f_nova',category:'character',gender:'F',asset:'/art/v29/characters/char_f_nova.svg',name:'노바',icon:'★',rarity:'mythic',price:620000000,desc:'JUNJA LAND 신규 프리미엄 컬렉션 캐릭터'},
  {id:'char_f_mirage',category:'character',gender:'F',asset:'/art/v29/characters/char_f_mirage.svg',name:'미라주',icon:'◇',rarity:'mythic',price:720000000,desc:'JUNJA LAND 신규 프리미엄 컬렉션 캐릭터'},
  {id:'char_f_valkyrie',category:'character',gender:'F',asset:'/art/v29/characters/char_f_valkyrie.svg',name:'발키리',icon:'⚜',rarity:'mythic',price:850000000,desc:'JUNJA LAND 신규 프리미엄 컬렉션 캐릭터'},
  {id:'char_f_serenity',category:'character',gender:'F',asset:'/art/v29/characters/char_f_serenity.svg',name:'세레니티',icon:'☾',rarity:'mythic',price:950000000,desc:'JUNJA LAND 신규 프리미엄 컬렉션 캐릭터'},
  {id:'char_admin_godjunja',category:'character',gender:'M',asset:'/art/v29/characters/char_admin_godjunja.svg',name:'GOD JUNJA',icon:'👑',rarity:'prestige',price:0,adminOnly:true,featured:true,desc:'오직 갓준자 관리자만 사용할 수 있는 절대적 시그니처 캐릭터'},
...
function currentTurnUserId(r){if(r.game==='holdem')return r.hand?.phase!=='complete'?r.hand?.turnUserId:null;if(r.game==='sevenpoker')return r.seven&&!r.seven.complete?r.seven.turnUserId:null;if(r.game==='yut'&&r.yut?.phase==='playing')return yutCurrentPlayer(r,r.yut)?.userId||null;return null;}
...
function sevenMStart(r){
  if(r.players.length!==2)throw new Error('세븐포커 멀티는 2명이 필요합니다.');if(r.seven&&!r.seven.complete)throw new Error('이미 핸드가 진행 중입니다.');
  const ids=sevenMIds(r);if(ids.some(id=>(roomPlayer(r,id)?.stack||0)<1000))throw new Error('두 플레이어 모두 최소 1,000G 이상의 테이블 칩이 필요합니다.');
...
function sevenMAction(r,userId,action,raiseTo){
  ...
  if(action==='fold'){s.folded[uid]=true;s.acted[uid]=true;sevenMFinish(r,other,'fold');return;}
  ...
  if(sevenMRoundDone(r,s)){sevenMAdvance(r);return;}s.turnUserId=other;if(s.allIn[other]){if(sevenMRoundDone(r,s))sevenMAdvance(r);else s.turnUserId=uid;}touchRoom(r);
}
